  ...
  if (props.kind === 'svg') {
    ...
    switch (svgProps.name) {
      case 'arrow-down-green-64': {
        const {
          SvgArrowDownGreen64,
        } = require('./svg/components/ArrowDownGreen64')
        return <SvgIcon Component={SvgArrowDownGreen64} {...svgProps} />
      }
      case 'arrow-top-white-64': {
        const {
          SvgArrowTopWhite64,
        } = require('./svg/components/ArrowTopWhite64')
      ...
      case 'dots-vertical-white-64': {
        const {
          SvgDotsVerticalWhite64,
        } = require('./svg/components/DotsVerticalWhite64')
      ...
      case 'error-circle-red-64': {
        const {
          SvgErrorCircleRed64,
        } = require('./svg/components/ErrorCircleRed64')
        return <SvgIcon Component={SvgErrorCircleRed64} {...svgProps} />
      }
      case 'filter-primery-64': {
        const {
          SvgFilterPrimery64,
        } = require('./svg/components/FilterPrimery64')
      ...
      case 'translate-primery-64': {
        const {
          SvgTranslatePrimery64,
        } = require('./svg/components/TranslatePrimery64')
